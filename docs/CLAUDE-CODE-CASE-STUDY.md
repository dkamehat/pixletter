# Claude Code Case Study: pixletter
...
| 指標 | 値 |
|------|-----|
| プロジェクト | pixletter — Gmail 開封・クリック追跡基盤 |
| 開発期間 | 1 セッション（約 6 時間） |
| コミット数 | 6 |
| ファイル数 | 49 |
...
| 本番デプロイ | `pixletter-api.kame-lift.workers.dev` |
| 月額コスト | ¥0 |
...
- **GitHub**: https://github.com/dkamehat/pixletter
- **本番 API**: https://pixletter-api.kame-lift.workers.dev/health
- **Tech Stack**: TypeScript, Hono, Cloudflare Workers/D1, React, Vite, Vitest

---

*Generated from pixletter project, built with Claude Code (Opus 4.6, 1M context).*
*Author: @kame__lift*
